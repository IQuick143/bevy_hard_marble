/// THIS CODE IS CREATED BY @rparrett and contributors,
/// licensed under MIT
/// source: https://github.com/rparrett/bevy_simple_text_input
/// 
/// Modifications have been made
/// 
/// A local copy is created and modified to fix some issues
/// that arose during kumbanet development.
...
impl Plugin for TextInputPlugin {
    fn build(&self, app: &mut App) {
        ...
        load_internal_binary_asset!(
            app,
            CURSOR_HANDLE,
            "../../assets/fonts/Cursor.ttf", // Modified asset path
...
fn keyboard(
    ...
    // Clearing events even if no text_input read them.
    events.clear();
